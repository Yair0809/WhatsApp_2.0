...
public class SendMessage {
    private JPanel messagePanelContainer; // Panel to hold messages
    ...
    public void sendMessage(String text) {
        ...
        messagePanel.setBackground(new Color(0x11460B)); // Set bubble color
        messagePanel.setBorder(new EmptyBorder(10, 15, 10, 15)); // Add padding inside bubble
